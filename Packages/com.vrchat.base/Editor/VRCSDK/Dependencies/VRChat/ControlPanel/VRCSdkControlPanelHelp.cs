...
namespace VRC.SDKBase.Editor
{
    public static class VRCSdkControlPanelHelp
    {
        ...
        [MenuItem("Syndicate Family SDK/Help/Developer FAQ")]
        ...
        [MenuItem("Syndicate Family SDK/Help/VRChat Discord")]
        ...
        [MenuItem("Syndicate Family SDK/Help/Avatar Optimization Tips")]
        ...
        [MenuItem("Syndicate Family SDK/Help/Avatar Rig Requirements")]
